...
class UserApi extends Api{
     ...
     */
    public function register($username, $password, $email, $mobile = '', $brand_name='', $category=0){
        return $this->model->register($username, $password, $email, $mobile, $brand_name, $category);
    }
    /**
     * 增加一个新用户
    ...
    public function memberAdd($fields){
    	return $this->model->memberAdd($fields);
    }
    /**
     * 用户登录认证
     * @param  string  $username 用户名

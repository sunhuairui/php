...
class DiyController extends AddonsController {
    ...
    function diy() {
        ...
        foreach ($dirs as $name) {
            ...
            empty($info ['set']) && $info ['set'] = wx_addons_url("Diy://Diy/param", $url_param);
            empty($info ['save']) && $info ['save'] = wx_addons_url("Diy://widget/saveTemplateCode");
            empty($info ['html']) && $info ['html'] = wx_addons_url("Diy://Widget/getTemplateCode");

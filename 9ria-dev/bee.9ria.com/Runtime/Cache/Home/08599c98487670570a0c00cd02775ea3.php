...
<div class="headerTop">
          ...
          <div class="modal-content"> 
               <div class="modal-body">
                    <form action="" class="comForm">
                        ...
                        <input type="hidden" value="<?php echo ($project_name); ?>" id="addname">
  ...
  <div class="shareBox">
    ...
    <span>&nbsp;&nbsp;&nbsp;这个模板太赞了，<a style="cursor:pointer" value="<?php echo U('project/create', 'name='.$project_name);?>"  name ="<?php echo ($project_name); ?>" data-toggle="modal" data-target="#create_add">我也要做!</a></span>
  </div>
</div>
 </div> 

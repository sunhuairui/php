...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="item[username]" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">密码<span class="check-tips">（用户密码不能少于6位）</span></label>
            <div class="controls">
                <input type="password" class="text input-large" name="item[password]" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">确认密码</label>
            <div class="controls">
                <input type="password" class="text input-large" name="item[repassword]" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">邮箱<span class="check-tips">（用户邮箱，用于找回密码等安全操作）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="item[email]" value="">
            </div>
        </div>
        <!-- <div class="form-item">
            <label class="item-label">企业名称</label>
            <div class="controls">
                <input type="text" class="text input-large" name="item[company_name]" value="">
            </div>
        </div>-->
         <div class="form-item">
            <label class="item-label">主要品牌</label>
            <div class="controls">
                <input type="text" class="text input-large" name="item[brand_name]" value="">
            </div>
        </div>
         <div class="form-item">
            <label class="item-label">联系电话</label>
            <div class="controls">
                <input type="text" class="text input-large" name="item[mobile]" value="">
            </div>
        </div>
         <div class="form-item">
            <label class="item-label">联系人</label>
            <div class="controls">
                <input type="text" class="text input-large" name="item[contact]" value="">
            </div>
        </div>
         <div class="form-item">
            <label class="item-label">公司所在地<span class="check-tips">（必需选择）</span></label>
            <div class="controls">
                <select name="item[city]" id="">
        ...
        <div class="form-item">
            <label class="item-label">公司年营业额<span class="check-tips">（必需选择）</span></label>
            <div class="controls">
                <select name="item[turnover]" id="">
                    <option value="0">请选择</option>
        ...
        <div class="form-item">
            <label class="item-label">所属行业<span class="check-tips">（必需选择）</span></label>
            <div class="controls">
        ...
        <div class="form-item">
            <label class="item-label">主要产品</label>
            <div class="controls">
                <input type="text" class="text input-large" name="item[production]" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">QQ</label>
            <div class="controls">
                <input type="text" class="text input-large" name="item[qq]" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">微信</label>
            <div class="controls">
                <input type="text" class="text input-large" name="item[wechat]" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">目标客户</label>
            <div class="controls">
                <input type="text" class="text input-large" name="item[customer]" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">备注</label>
            <div class="controls">
               <label class="textarea input-large"><textarea name="item[remarks]"></textarea></label>
            </div>
        </div>
        <div class="form-item">

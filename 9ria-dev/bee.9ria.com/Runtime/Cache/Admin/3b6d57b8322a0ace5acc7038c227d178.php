...
<body>
    ...
    <div class="main-title">
        <h2>[<?php echo ($project["username"]); ?>] - [<?php echo ($project["title"]); ?>] 列表</h2>
    </div>
    <div class="cf">
        <div class="fl">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                <input type="text" name="code" class="search-input" value="<?php echo I('code');?>" placeholder="支持昵称|电话|地址查询">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Statistics/view','id='.I('id',0),false);?>"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
    <!-- 数据列表 -->
        ...
        <div class="data-table table-striped">
            <table>
                ...
                <tbody>
                    ...
                    <?php else: ?>
			        <td colspan="6" class="text-center"><?php echo ($errorHtml); ?></td><?php endif; ?>
                </tbody>
            </table>
        </div>
    </div>

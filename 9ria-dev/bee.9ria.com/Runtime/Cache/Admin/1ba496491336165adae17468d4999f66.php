...
<html>
    <head>
        <meta charset="UTF-8">
        <title><?php echo ((isset($meta_title) && ($meta_title !== ""))?($meta_title):'后台管理平台'); ?></title>
    ...
    <body class="index-body">
        ...
        <div class="header">
            ...
            <div class="user-bar">
                ...
                <ul class="nav-list user-menu hidden">
                    ...
                    <li><a href="<?php echo SITE_URL;?>">返回前台</a></li>
        ...
        <!-- 底部版权 -->
        <div class="cont-ft">
            <div class="copyright"> ©2014 <a href="http://www.9ria.com" target="_blank">9RIA蜂群工作室</a>版权所有</div>
        </div>

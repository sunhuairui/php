...
<body>
    ...
    <div class="cf">
        ...
        <?php if(empty($model["extend"])): ?><div class="tools">
                ...
                <button class="btn ajax-post" target-form="ids" url="<?php echo U("Project/setStatus",array("status"=>2));?>">发 布</button>
                <button class="btn ajax-post" target-form="ids" url="<?php echo U("Project/setStatus",array("status"=>0));?>">下 线</button>
            </div><?php endif; ?>
        </div>
        <!-- 高级搜索 -->

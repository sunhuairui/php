...
class BaseController extends AddonsController {
    ...
    protected function _initialize() {
        ...
        $res ['title'] = '图文回复';
        $res ['url'] = wx_addons_url('CustomReply://CustomReply/lists');
        $res ['class'] = $controller == 'customreply' ? 'current' : '';
        $nav [] = $res;

        $res ['title'] = '多图文设置';
        $res ['url'] = wx_addons_url('CustomReply://CustomReplyMult/lists');
        $res ['class'] = $controller == 'customreplymult' ? 'current' : '';
        $nav [] = $res;

        $res ['title'] = '文本回复';
        $res ['url'] = wx_addons_url('CustomReply://CustomReplyText/lists');

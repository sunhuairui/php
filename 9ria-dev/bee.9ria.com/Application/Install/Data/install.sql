...
CREATE TABLE `wp_action_log` (
  ...
  `action_ip` int(10) unsigned NOT NULL COMMENT '执行行为者ip',
...
) ENGINE=InnoDB AUTO_INCREMENT=1447 DEFAULT CHARSET=utf8 COMMENT='行为日志表';
...
CREATE TABLE `wp_addons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='插件表';
...
CREATE TABLE `wp_attribute` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=794 DEFAULT CHARSET=utf8 COMMENT='模型属性表';
...
INSERT INTO `wp_attribute` VALUES ('788', 'cTime', '发布时间', 'int(10) UNSIGNED NOT NULL', 'datetime', '', '', '0', '', '97', '0', '1', '1396624612', '1396075102', '', '3', '', 'regex', 'time', '1', 'function');
INSERT INTO `wp_attribute` VALUES ('789', 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', '0', '', '97', '0', '1', '1396602871', '1396602859', '', '3', '', 'regex', 'get_token', '1', 'function');
INSERT INTO `wp_attribute` VALUES ('790', 'level', '最多级数', 'tinyint(1) unsigned NOT NULL', 'select', '3', '', '1', '1:1级\r\n2:2级\r\n3:3级\r\n4:4级\r\n5:5级\r\n6:6级\r\n7:7级', '97', '0', '1', '1404193097', '1404192897', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `wp_attribute` VALUES ('791', 'code', '分类扩展编号', 'varchar(255) NOT NULL', 'string', '', '原分类或者导入分类的扩展编号', '0', '', '84', '0', '1', '1404182741', '1404182630', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `wp_attribute` VALUES ('792', 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', '0', '', '94', '0', '1', '1404525428', '1404525428', '', '3', '', 'regex', 'get_token', '1', 'function');
INSERT INTO `wp_attribute` VALUES ('793', 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', '0', '', '92', '0', '1', '1404525481', '1404525481', '', '3', '', 'regex', 'get_token', '1', 'function');
...
INSERT INTO `wp_config` VALUES ('46', 'SYSTEM_UPDATRE_VERSION', '0', '系统升级最新版本号', '4', '', '记录当前系统的版本号，这是与官方比较是否有升级包的唯一标识，不熟悉者只勿改变其数值', '1393764702', '1394337646', '1', '20140711', '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='文档模型基础表';
...
CREATE TABLE `wp_member` (
  ...
  `extra_field` text,
  PRIMARY KEY (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=111 DEFAULT CHARSET=utf8 COMMENT='会员表';
...
CREATE TABLE `wp_member_public` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `proj_name` varchar(20) NOT NULL COMMENT '项目名称',
  `proj_desc` varchar(40) NOT NULL COMMENT '项目描述',
  `uid` int(10) unsigned NOT NULL COMMENT '用户ID',
  ...
  `is_use` tinyint(2) NOT NULL DEFAULT '0' COMMENT '是否为当前项目',
...
CREATE TABLE `wp_model` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=utf8 COMMENT='文档模型表';
...
INSERT INTO `wp_model` VALUES ('5', 'keyword', '关键词表', '0', '', '1', '{\"1\":[\"keyword\",\"addon\",\"aim_id\",\"cTime\",\"keyword_type\",\"extra_text\",\"extra_int\"]}', '1:基础', '', '', '', '', 'id:编号\r\nkeyword:关键词\r\naddon:所属插件\r\naim_id:插件数据ID\r\ncTime|time_format:增加时间\r\nrequest_count|intval:请求数\r\nid:操作:[EDIT]|编辑,[DELETE]|删除', '10', 'keyword', '', '1388815871', '1388929956', '1', 'InnoDB');
INSERT INTO `wp_model` VALUES ('7', 'vote_option', '投票选项', '0', '', '1', '', '1:基础', '', '', '', '', '', '10', '', '', '1388933346', '1388933346', '1', 'InnoDB');
INSERT INTO `wp_model` VALUES ('8', 'vote_log', '投票记录', '0', '', '1', '', '1:基础', '', '', '', '', '', '10', '', '', '1388934136', '1388934136', '1', 'InnoDB');
...
INSERT INTO `wp_model` VALUES ('16', 'forum', '论坛区', '0', '', '1', '', '1:基础', '', '', '', '', '', '10', '', '', '1394033250', '1394033250', '1', 'InnoDB');
INSERT INTO `wp_model` VALUES ('17', 'store', '插件商店', '0', '', '1', '', '1:基础', '', '', '', '', '', '10', '', '', '1394033250', '1394033250', '1', 'InnoDB');
...
INSERT INTO `wp_model` VALUES ('65', 'custom_reply_mult', '多图文配置', '0', '', '1', '', '1:基础', '', '', '', '', '', '10', '', '', '1396602475', '1396602475', '1', 'InnoDB');
...
INSERT INTO `wp_model` VALUES ('71', 'forms_value', '通用表单数据', '0', '', '1', '', '1:基础', '', '', '', '', '', '10', '', '', '1396687959', '1396687959', '1', 'InnoDB');
...
INSERT INTO `wp_model` VALUES ('96', 'tongji', '运营统计', '0', '', '1', '{\"1\":[\"month\",\"day\",\"content\"]}', '1:基础', '', '', '', '', 'day:日期', '10', 'day', '', '1401371050', '1401371409', '1', 'InnoDB');
...
CREATE TABLE `wp_ucenter_member` (
  ...
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=363 DEFAULT CHARSET=utf8 COMMENT='用户表';
...
CREATE TABLE `wp_weixin_log` (
  ...
  `data_post` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7213 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of wp_weixin_log
-- ----------------------------
DROP TABLE IF EXISTS `wp_stat_log`;
CREATE TABLE `wp_stat_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `identification` varchar(100) NOT NULL COMMENT '用户唯一码',
  `project_id` int(10) unsigned NOT NULL COMMENT '项目id',
  `action_mid` int(10) unsigned NOT NULL COMMENT '动作映射id',
  `create_time` int(10) NOT NULL COMMENT '创建时间',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态, 1有效，0无效',
  PRIMARY KEY (`id`),
  KEY `idx_identification` (`identification`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT '统计流水表';

DROP TABLE IF EXISTS `wp_action_map`;
CREATE TABLE `wp_action_map` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `project_id` int(10) unsigned NOT NULL COMMENT '项目id',
  `name` varchar(20) NOT NULL COMMENT '动作标识',
  ...
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态, 1有效，0无效',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT '动作映射表';
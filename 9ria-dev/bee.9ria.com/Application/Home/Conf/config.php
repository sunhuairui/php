...
return array(
    ...
    /* SESSION 和 COOKIE 配置 */
    'SESSION_PREFIX' => 'bee_home', //session前缀
    'COOKIE_PREFIX' => 'bee_home_', // Cookie前缀 避免冲突
    ...
    'URL_ROUTE_RULES' => array(
    	'/^app\/codelist$/' => 'index.php?s=Home/GameCreator/codelist.html',
        '/play/:appid/'=>'Home/GameCreator/play?appid=:1',
    ),
);
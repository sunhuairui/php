...
(function() {
    ...
    function initLocal() {
        if (!elemLocal)
            elemLocal = $('<div class="upload_wrap" style="width:220px;"><div class="local"><input type="file" id="upload_picture_file"></div><div class="preview"></div></div>');
    ...
    function initWeb() {
        if (!elemWeb)
            elemWeb = $('<div class="upload_wrap" style="width:520px;"><div class="web"><input type="text" id="webPicLink"/><button class="btn">上传 </button></div></div>');
    ...
    function initOnline() {
        if (!elemOnline)
            elemOnline = $('<div class="online_wrap"><div class="pic_list"></div><div class="image_page"></div></div>');
